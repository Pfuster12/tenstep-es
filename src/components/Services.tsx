...
export default function Services() {
    return (
        <r-grid id="services" class="py-24 px-8" columns="8">
            <r-cell span="row">
            ...
            <r-cell class="mt-12" span="2-7" span-l="3-6" span-s="1-8">
            ...
            <r-cell class="mt-12 flex justify-end" span-l="3-6" span="1-8">
            ...
            <r-cell class="mt-12 flex justify-end" span-l="3-6" span="2-7" span-s="1-8">
