...
export default function About() {
    return (
        ...
        <r-cell class="flex flex-col pt-16" span="2-5" span-s="2-7">
            <h1>About</h1>
            <p className="pt-6 max-w-4xl">
                Corporate Solutions S.A, the member of
                <a className="text-primary"
                href="https://www.giminstitute.org/"> GIMI Network</a>, based in
                Spain, specializes in consulting and advisory services to win and
                manage projects, funded generally by international institutions
                which foster economic development. It is a Global Partner of the
                Global Innovation Management Institute (GIMI) and global Advisor
